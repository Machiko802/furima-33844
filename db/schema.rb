...
ActiveRecord::Schema.define(version: 2021_03_13_055905) do
  ...
  create_table "customer_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_customer_addresses_on_purchase_record_id"
  end
  ...
  add_foreign_key "customer_addresses", "purchase_records"
